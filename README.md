...
> Reproducible pipeline for the paper **“Parameter-Efficient Quantum
> Sentiment Classification: A Controlled Empirical Study of DisCoCat on
> SST-2.”**
>
...
@article{doletran2026qnlp,
  title  = {Parameter-Efficient Quantum Sentiment Classification:
...
guidance on the direction of this work, and the open-source
`lambeq` and PennyLane development teams for making this research
possible.
